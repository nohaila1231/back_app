# This script will create the exact content you need to replace in your user_controller.py

fixed_controller_content = '''from flask_cors import cross_origin 
...
@cross_origin(supports_credentials=True, origins=["https://client-enqldel1w-louraknouhaila-5950s-projects.vercel.app", "http://127.0.0.1:5173"])
...
with open("user_controller_FIXED.py", "w", encoding="utf-8") as f:
    f.write(fixed_controller_content)

print("✅ Fichier user_controller_FIXED.py créé avec succès!")
print()
print("🔧 INSTRUCTIONS POUR CORRIGER LE PROBLÈME:")
print("1. Copiez tout le contenu du fichier user_controller_FIXED.py")
print("2. Remplacez COMPLÈTEMENT le contenu de votre fichier user_controller.py actuel")
print("3. Redémarrez votre serveur backend")
print()
print("📋 Les corrections apportées:")
print("   ✅ Import correct: from models.like import Like")
print("   ✅ Utilisation de 'added_at' au lieu de 'created_at' pour Watchlist")
print("   ✅ Fonction get_favorite_genres_simple sans erreur d'import")
